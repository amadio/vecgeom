...
inline void CompareUnplacedContains(VPlacedVolume const *vol, bool vecgeomresult, Vector3D<Precision> const &point)
{
...
inline void PrintPointInformation(VPlacedVolume const *vol, Vector3D<Precision> const &point)
{
...
inline void CompareDistanceToIn(VPlacedVolume const *vol, Precision vecgeomresult, Vector3D<Precision> const &point,
...
inline void CompareDistanceToOut(VPlacedVolume const *vol, Precision vecgeomresult, Vector3D<Precision> const &point,
                                 Vector3D<Precision> const &direction,
                                 Precision const stepMax = VECGEOM_NAMESPACE::kInfinity)
{
#ifdef VECGEOM_ROOT
