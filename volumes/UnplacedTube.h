...
public:
  ...
  VECGEOM_CUDA_HEADER_BOTH
  UnplacedTube(UnplacedTube const &other)
      : fRmin(other.fRmin), fRmax(other.fRmax), fZ(other.fZ), fSphi(other.fSphi), fDphi(other.fDphi),
        fRmin2(other.fRmin2), fRmax2(other.fRmax2), fAlongPhi1x(other.fAlongPhi1x), fAlongPhi1y(other.fAlongPhi1y),
        fAlongPhi2x(other.fAlongPhi2x), fAlongPhi2y(other.fAlongPhi2y), fTolIrmin2(other.fTolIrmin2),
        fTolOrmin2(other.fTolOrmin2), fTolIrmax2(other.fTolIrmax2), fTolOrmax2(other.fTolOrmax2), fTolIz(other.fTolIz),
        fTolOz(other.fTolOz), fPhiWedge(other.fDphi, other.fSphi)
  {
  ...
  VECGEOM_CUDA_HEADER_BOTH
  VECGEOM_INLINE
  Precision volume() const { return fZ * (fRmax2 - fRmin2) * fDphi; }
