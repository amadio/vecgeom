    ...
    inline namespace VECGEOM_IMPL_NAMESPACE
{
  ...
  struct ParaboloidImplementation {
                             ...
                             typename Backend::precision_v const & /*stepMax*/, typename Backend::precision_v &distance)
    {
      ...
      Bool_t isDistancingInXY =
          ((rho2 > unplaced.GetRhi2()) && (point_dot_direction_x > 0 && point_dot_direction_y > 0));
      ...
      MaskedAssign(localPoint.z() < -unplaced.GetDz() && localDirection.z() > 0, unplaced.GetRlo2(),
                   &ray2); // verificare
