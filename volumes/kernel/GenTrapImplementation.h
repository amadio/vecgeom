    ...
    inline namespace VECGEOM_IMPL_NAMESPACE
{
  ...
  struct GenTrapImplementation {
    ...
    VECGEOM_INLINE
    VECGEOM_CUDA_HEADER_BOTH
    static void DistanceToInKernel(UnplacedGenTrap const &unplaced,
                                   Vector3D<typename Backend::precision_v> const &point,
                                   Vector3D<typename Backend::precision_v> const &direction,
    ...
    VECGEOM_INLINE
    VECGEOM_CUDA_HEADER_BOTH
    static void DistanceToOutKernel(UnplacedGenTrap const &unplaced,
                                    Vector3D<typename Backend::precision_v> const &point,
                                    Vector3D<typename Backend::precision_v> const &direction,
                                    typename Backend::precision_v const &stepMax,
                                    typename Backend::precision_v &distance);
  ...
  typename Backend::bool_v IsInTopOrBottomPolygon(
      UnplacedGenTrap const &unplaced, typename Backend::precision_v const &pointx,
