    ...
    inline namespace VECGEOM_IMPL_NAMESPACE
{
  ...
  **/
                      ...
                      typename Backend::precision_v &safety)
  {
    ...
    MaskedAssign(phi1 > -kHalfTolerance && pos.x() * tube.alongPhi1x() + pos.y() * tube.alongPhi1y() > 0 &&
                     phi1 < safety,
                 phi1, &safety);
    ...
    // make sure point falls on positive part of projection
    MaskedAssign(phi2 > -kHalfTolerance && pos.x() * tube.alongPhi2x() + pos.y() * tube.alongPhi2y() > 0 &&
                     phi2 < safety,
                 phi2, &safety);
  }
