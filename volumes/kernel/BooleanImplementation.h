...
VECGEOM_DEVICE_DECLARE_CONV_TEMPLATE_3v(struct, BooleanImplementation, BooleanOperation, Arg1, TranslationCode, translation::kGeneric, RotationCode, rotation::kGeneric)
