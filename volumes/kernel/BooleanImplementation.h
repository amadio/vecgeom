    ...
    inline namespace VECGEOM_IMPL_NAMESPACE
{
  ...
  struct BooleanImplementation<kSubtraction, transCodeT, rotCodeT> {
    ...
    VECGEOM_INLINE
    VECGEOM_CUDA_HEADER_BOTH
    static void DistanceToOut(UnplacedBooleanVolume const &unplaced,
                              Vector3D<typename Backend::precision_v> const &point,
                              Vector3D<typename Backend::precision_v> const &direction,
                              typename Backend::precision_v const &stepMax, typename Backend::precision_v &distance);
    ...
    VECGEOM_INLINE
    VECGEOM_CUDA_HEADER_BOTH
    static void InsideKernel(UnplacedBooleanVolume const &unplaced,
                             Vector3D<typename Backend::precision_v> const &point, typename Backend::inside_v &inside);
    ...
    VECGEOM_INLINE
    VECGEOM_CUDA_HEADER_BOTH
    static void NormalKernel(UnplacedBooleanVolume const &unplaced,
                             Vector3D<typename Backend::precision_v> const &point,
