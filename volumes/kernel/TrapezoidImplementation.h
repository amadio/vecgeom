    ...
    inline namespace VECGEOM_IMPL_NAMESPACE
{
  ...
  struct TrapezoidImplementation {
    ...
    VECGEOM_INLINE
    VECGEOM_CUDA_HEADER_BOTH
    static void UnplacedContains(UnplacedTrapezoid const &unplaced,
  ...
  void TrapezoidImplementation<transCodeT, rotCodeT>::Contains(
      ...
      Vector3D<typename Backend::precision_v> const &masterPoint, Vector3D<typename Backend::precision_v> &localPoint,
      typename Backend::bool_v &inside)
  {
