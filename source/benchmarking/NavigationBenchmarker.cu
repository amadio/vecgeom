                                 ...
                                 Precision *const steps)
{
  ...
  while (tid < n) {
    ...
    NavigationState *inState =
        reinterpret_cast<NavigationState *>((char *)gpu_ptr + tid * NavigationState::SizeOf(depth));
    NavigationState *outState =
        reinterpret_cast<NavigationState *>((char *)gpu_out_ptr + tid * NavigationState::SizeOf(depth));
