...
void CreateNuclei0002() {
  ...
  // Adding 73-TA-174-0
  nuc = new Nucleus("TA", 174, 73, 0, 173.944, 0, 3780, 0, 5.7e-11, 6.6e-11, 0,
                    0);
  ...
  // Adding 69-TM-175-0
  nuc =
      new Nucleus("TM", 175, 69, 0, 174.944, 0, 912, 0, 2.7e-11, 3.1e-11, 0, 0);
  nuc->AddDecay(0, 1, 0, 2.38498, 100);

  // Adding 70-YB-175-0
  nuc = new Nucleus("YB", 175, 70, 0, 174.941, 0, 361584, 0, 4.4e-10, 7e-10, 0,
                    0);
  ...
  // Adding 72-HF-175-0
  nuc = new Nucleus("HF", 175, 72, 0, 174.941, 0, 6.048e+06, 0, 4.1e-10,
                    1.1e-09, 0, 0);
  nuc->AddDecay(0, -1, 0, 0.685791, 100);

  // Adding 73-TA-175-0
  nuc =
      new Nucleus("TA", 175, 73, 0, 174.944, 0, 37800, 0, 2.1e-10, 2e-10, 0, 0);
  ...
  // Adding 71-LU-176-0
  nuc = new Nucleus("LU", 176, 71, 0, 175.943, 0, 1.19206e+18, 2.59, 1.8e-09,
                    6.6e-08, 0, 0);
  nuc->AddDecay(0, 1, 0, 1.1916, 100);

  // Adding 71-LU-176-1
  nuc = new Nucleus("LU", 176, 71, 1, 175.943, 0.123, 13086, 0, 1.7e-10,
                    1.6e-10, 0, 0);
  ...
  // Adding 73-TA-176-0
  nuc = new Nucleus("TA", 176, 73, 0, 175.945, 0, 29124, 0, 3.2e-10, 3.3e-10, 0,
                    0);
  nuc->AddDecay(0, -1, 0, 3.11002, 100);

  // Adding 74-W-176-0
  nuc =
      new Nucleus("W", 176, 74, 0, 175.946, 0, 9000, 0, 1.1e-10, 7.6e-11, 0, 0);
  ...
  // Adding 70-YB-177-0
  nuc = new Nucleus("YB", 177, 70, 0, 176.945, 0, 6879.6, 0, 9.7e-11, 9.4e-11,
                    0, 0);
  ...
  // Adding 71-LU-177-0
  nuc = new Nucleus("LU", 177, 71, 0, 176.944, 0, 581818, 0, 5.3e-10, 1.2e-09,
                    0, 0);
  nuc->AddDecay(0, 1, 0, 0.498196, 100);

  // Adding 71-LU-177-1
  nuc = new Nucleus("LU", 177, 71, 1, 176.945, 0.97, 1.38586e+07, 0, 1.7e-09,
                    1.5e-08, 0, 0);
  ...
  // Adding 72-HF-177-1
  nuc = new Nucleus("HF", 177, 72, 1, 176.945, 1.315, 1.08, 0, 8.1e-11, 1.5e-10,
                    0, 0);
  ...
  // Adding 73-TA-177-0
  nuc = new Nucleus("TA", 177, 73, 0, 176.944, 0, 203616, 0, 1.1e-10, 1.3e-10,
                    0, 0);
  nuc->AddDecay(0, -1, 0, 1.16599, 100);

  // Adding 74-W-177-0
  nuc =
      new Nucleus("W", 177, 74, 0, 176.947, 0, 8100, 0, 6.1e-11, 4.6e-11, 0, 0);
  nuc->AddDecay(0, -1, 0, 2.00064, 100);

  // Adding 75-RE-177-0
  nuc =
      new Nucleus("RE", 177, 75, 0, 176.95, 0, 840, 0, 2.2e-11, 2.2e-11, 0, 0);
  ...
  // Adding 70-YB-178-0
  nuc = new Nucleus("YB", 178, 70, 0, 177.947, 0, 4440, 0, 1.2e-10, 1.1e-10, 0,
                    0);
  nuc->AddDecay(0, 1, 0, 0.644623, 100);

  // Adding 71-LU-178-0
  nuc = new Nucleus("LU", 178, 71, 0, 177.946, 0, 1704, 0, 4.7e-11, 4.1e-11, 0,
                    0);
  nuc->AddDecay(0, 1, 0, 2.09919, 100);

  // Adding 71-LU-178-1
  nuc = new Nucleus("LU", 178, 71, 1, 177.946, 0.22, 1386, 0, 3.8e-11, 5.6e-11,
                    0, 0);
  ...
  // Adding 72-HF-178-1
  nuc = new Nucleus("HF", 178, 72, 1, 177.945, 1.147, 4, 0, 4.7e-09, 3.1e-07, 0,
                    0);
  nuc->AddDecay(0, 0, -1, 1.147, 100);

  // Adding 72-HF-178-2
  nuc =
      new Nucleus("HF", 178, 72, 2, 177.946, 2.446, 9.77616e+08, 0, 0, 0, 0, 0);
  nuc->AddDecay(0, 0, -2, 2.446, 100);

  // Adding 73-TA-178-0
  nuc = new Nucleus("TA", 178, 73, 0, 177.946, 0, 558.6, 0, 7.8e-11, 1.1e-10, 0,
                    0);
  ...
  // Adding 74-W-178-0
  nuc = new Nucleus("W", 178, 74, 0, 177.946, 0, 1.86624e+06, 0, 2.5e-10,
                    1.2e-10, 0, 0);
  nuc->AddDecay(0, -1, 0, 0.091301, 100);

  // Adding 75-RE-178-0
  nuc =
      new Nucleus("RE", 178, 75, 0, 177.951, 0, 792, 0, 2.5e-11, 2.4e-11, 0, 0);
  ...
  // Adding 71-LU-179-0
  nuc = new Nucleus("LU", 179, 71, 0, 178.947, 0, 16524, 0, 2.1e-10, 1.7e-10, 0,
                    0);
  ...
  // Adding 72-HF-179-1
  nuc = new Nucleus("HF", 179, 72, 1, 178.946, 0.375, 18.67, 0, 1.3e-09,
                    3.6e-09, 0, 0);
  nuc->AddDecay(0, 0, -1, 0.375, 100);

  // Adding 72-HF-179-2
  nuc =
      new Nucleus("HF", 179, 72, 2, 178.947, 1.106, 2.16864e+06, 0, 0, 0, 0, 0);
  nuc->AddDecay(0, 0, -2, 1.106, 100);

  // Adding 73-TA-179-0
  nuc = new Nucleus("TA", 179, 73, 0, 178.946, 0, 5.64494e+07, 0, 6.5e-11,
                    5.2e-10, 0, 0);
  nuc->AddDecay(0, -1, 0, 0.110371, 100);

  // Adding 74-W-179-0
  nuc =
      new Nucleus("W", 179, 74, 0, 178.947, 0, 2250, 0, 3.3e-12, 1.8e-12, 0, 0);
  ...
  // Adding 72-HF-180-1
  nuc = new Nucleus("HF", 180, 72, 1, 179.948, 1.142, 19800, 0, 1.7e-10, 2e-10,
                    0, 0);
  nuc->AddDecay(0, 0, -1, 1.142, 98.6);
  nuc->AddDecay(0, 1, -1, 0.288002, 1.4);

  // Adding 73-TA-180-0
  nuc = new Nucleus("TA", 180, 73, 0, 179.947, 0, 29347.2, 0, 8.4e-10, 2.4e-08,
                    0, 0);
  nuc->AddDecay(0, -1, 0, 0.853996, 86);
  nuc->AddDecay(0, 1, 0, 0.708015, 14);

  // Adding 73-TA-180-1
  nuc = new Nucleus("TA", 180, 73, 1, 179.948, 0.075, 0, 0.0122, 5.4e-11,
                    6.2e-11, 0, 0);
  ...
  // Adding 76-OS-180-0
  nuc = new Nucleus("OS", 180, 76, 0, 179.952, 0, 1290, 0, 1.7e-11, 2.5e-11, 0,
                    0);
  ...
  // Adding 72-HF-181-0
  nuc = new Nucleus("HF", 181, 72, 0, 180.949, 0, 3.6625e+06, 0, 1.1e-09,
                    4.7e-09, 0, 0);
  ...
  // Adding 74-W-181-0
  nuc = new Nucleus("W", 181, 74, 0, 180.948, 0, 1.04717e+07, 0, 8.2e-11,
                    4.3e-11, 0, 0);
  nuc->AddDecay(0, -1, 0, 0.187878, 100);

  // Adding 75-RE-181-0
  nuc = new Nucleus("RE", 181, 75, 0, 180.95, 0, 71640, 0, 4.2e-10, 3.7e-10, 0,
                    0);
  nuc->AddDecay(0, -1, 0, 1.73854, 100);

  // Adding 76-OS-181-0
  nuc =
      new Nucleus("OS", 181, 76, 0, 180.953, 0, 6300, 0, 8.9e-11, 1e-10, 0, 0);
  ...
  // Adding 72-HF-182-0
  nuc = new Nucleus("HF", 182, 72, 0, 181.951, 0, 2.83824e+14, 0, 3e-09,
                    3.6e-07, 0, 0);
  nuc->AddDecay(0, 1, 0, 0.373066, 100);

  // Adding 72-HF-182-1
  nuc = new Nucleus("HF", 182, 72, 1, 181.952, 1.173, 3690, 0, 4.2e-11, 7.1e-11,
                    0, 0);
  nuc->AddDecay(0, 0, -1, 1.173, 42);
  nuc->AddDecay(0, 1, -1, 1.54607, 58);

  // Adding 73-TA-182-0
  nuc = new Nucleus("TA", 182, 73, 0, 181.95, 0, 9.88675e+06, 0, 1.5e-09,
                    9.8e-09, 0, 0);
  nuc->AddDecay(0, 1, 0, 1.8136, 100);

  // Adding 73-TA-182-1
  nuc = new Nucleus("TA", 182, 73, 1, 181.95, 0.016, 0.283, 0, 1.2e-11, 3.6e-11,
                    0, 0);
  ...
  // Adding 75-RE-182-0
  nuc = new Nucleus("RE", 182, 75, 0, 181.951, 0, 230400, 0, 1.4e-09, 1.7e-09,
                    0, 0);
  nuc->AddDecay(0, -1, 0, 2.80002, 100);

  // Adding 75-RE-182-1
  nuc =
      new Nucleus("RE", 182, 75, 1, 181.951, 0, 45720, 0, 2.7e-10, 3e-10, 0, 0);
  nuc->AddDecay(0, -1, -1, 2.80002, 100);

  // Adding 76-OS-182-0
  nuc = new Nucleus("OS", 182, 76, 0, 181.952, 0, 79560, 0, 5.6e-10, 5.3e-10, 0,
                    0);
  ...
  // Adding 72-HF-183-0
  nuc = new Nucleus("HF", 183, 72, 0, 182.954, 0, 3841.2, 0, 7.3e-11, 8.3e-11,
                    0, 0);
  nuc->AddDecay(0, 1, 0, 2.01, 100);

  // Adding 73-TA-183-0
  nuc = new Nucleus("TA", 183, 73, 0, 182.951, 0, 440640, 0, 1.3e-09, 2e-09, 0,
                    0);
  ...
  // Adding 75-RE-183-0
  nuc = new Nucleus("RE", 183, 75, 0, 182.951, 0, 6.048e+06, 0, 7.6e-10,
                    1.8e-09, 0, 0);
  ...
  // Adding 72-HF-184-0
  nuc = new Nucleus("HF", 184, 72, 0, 183.955, 0, 14832, 0, 5.3e-10, 4.5e-10, 0,
                    0);
  nuc->AddDecay(0, 1, 0, 1.33998, 100);

  // Adding 73-TA-184-0
  nuc = new Nucleus("TA", 184, 73, 0, 183.954, 0, 31320, 0, 6.8e-10, 6.3e-10, 0,
                    0);
  ...
  // Adding 75-RE-184-0
  nuc = new Nucleus("RE", 184, 75, 0, 183.953, 0, 3.2832e+06, 0, 1e-09, 1.8e-09,
                    0, 0);
  nuc->AddDecay(0, -1, 0, 1.48267, 100);

  // Adding 75-RE-184-1
  nuc = new Nucleus("RE", 184, 75, 1, 183.953, 0.188, 1.46016e+07, 0, 1.5e-09,
                    6.1e-09, 0, 0);
  ...
  // Adding 77-IR-184-0
  nuc = new Nucleus("IR", 184, 77, 0, 183.957, 0, 11124, 0, 1.7e-10, 1.9e-10, 0,
                    0);
  ...
  // Adding 73-TA-185-0
  nuc = new Nucleus("TA", 185, 73, 0, 184.956, 0, 2940, 0, 6.8e-11, 7.2e-11, 0,
                    0);
  nuc->AddDecay(0, 1, 0, 1.99201, 100);

  // Adding 74-W-185-0
  nuc = new Nucleus("W", 185, 74, 0, 184.953, 0, 6.48864e+06, 0, 5e-10, 2.2e-10,
                    0, 0);
  ...
  // Adding 76-OS-185-0
  nuc = new Nucleus("OS", 185, 76, 0, 184.954, 0, 8.08704e+06, 0, 5.1e-10,
                    1.5e-09, 0, 0);
  nuc->AddDecay(0, -1, 0, 1.0128, 100);

  // Adding 77-IR-185-0
  nuc = new Nucleus("IR", 185, 77, 0, 184.957, 0, 51840, 0, 2.6e-10, 2.6e-10, 0,
                    0);
  ...
  // Adding 73-TA-186-0
  nuc =
      new Nucleus("TA", 186, 73, 0, 185.959, 0, 630, 0, 3.3e-11, 3.1e-11, 0, 0);
  ...
  // Adding 75-RE-186-0
  nuc = new Nucleus("RE", 186, 75, 0, 185.955, 0, 326304, 0, 1.5e-09, 1.2e-09,
                    0, 0);
  nuc->AddDecay(0, 1, 0, 1.0695, 93.1);
  nuc->AddDecay(0, -1, 0, 0.5816, 6.9);

  // Adding 75-RE-186-1
  nuc = new Nucleus("RE", 186, 75, 1, 185.955, 0.149, 6.3072e+12, 0, 2.2e-09,
                    1.1e-08, 0, 0);
  ...
  // Adding 77-IR-186-0
  nuc =
      new Nucleus("IR", 186, 77, 0, 185.958, 0, 59904, 0, 4.9e-10, 5e-10, 0, 0);
  nuc->AddDecay(0, -1, 0, 3.83101, 100);

  // Adding 77-IR-186-1
  nuc = new Nucleus("IR", 186, 77, 1, 185.958, 0, 7200, 0, 6.1e-11, 7.1e-11, 0,
                    0);
  nuc->AddDecay(0, -1, -1, 3.83101, 100);
  nuc->AddDecay(0, 0, -1, 0, 0);

  // Adding 78-PT-186-0
  nuc = new Nucleus("PT", 186, 78, 0, 185.959, 0, 7200, 0, 9.3e-11, 6.6e-11, 0,
                    0);
  ...
  // Adding 74-W-187-0
  nuc = new Nucleus("W", 187, 74, 0, 186.957, 0, 85392, 0, 7.1e-10, 3.3e-10, 0,
                    0);
  nuc->AddDecay(0, 1, 0, 1.3112, 100);

  // Adding 75-RE-187-0
  nuc = new Nucleus("RE", 187, 75, 0, 186.956, 0, 1.37182e+18, 62.6, 5.1e-12,
                    6e-12, 1, 0);
  ...
  // Adding 77-IR-187-0
  nuc = new Nucleus("IR", 187, 77, 0, 186.957, 0, 37800, 0, 1.2e-10, 1.2e-10, 0,
                    0);
  ...
  // Adding 74-W-188-0
  nuc = new Nucleus("W", 188, 74, 0, 187.958, 0, 5.99616e+06, 0, 2.3e-09,
                    8.4e-10, 0, 0);
  nuc->AddDecay(0, 1, 0, 0.348988, 100);

  // Adding 75-RE-188-0
  nuc = new Nucleus("RE", 188, 75, 0, 187.958, 0, 61128, 0, 1.4e-09, 7.5e-10, 0,
                    0);
  nuc->AddDecay(0, 1, 0, 2.1204, 100);

  // Adding 75-RE-188-1
  nuc = new Nucleus("RE", 188, 75, 1, 187.958, 0.172, 1116, 0, 3e-11, 2e-11, 0,
                    0);
  ...
  // Adding 77-IR-188-0
  nuc = new Nucleus("IR", 188, 77, 0, 187.959, 0, 149400, 0, 6.3e-10, 6.2e-10,
                    0, 0);
  nuc->AddDecay(0, -1, 0, 2.80935, 100);

  // Adding 78-PT-188-0
  nuc = new Nucleus("PT", 188, 78, 0, 187.959, 0, 881280, 0, 7.6e-10, 6.3e-10,
                    0, 0);
  ...
  // Adding 75-RE-189-0
  nuc =
      new Nucleus("RE", 189, 75, 0, 188.959, 0, 87480, 0, 7.8e-10, 6e-10, 0, 0);
  ...
  // Adding 76-OS-189-1
  nuc = new Nucleus("OS", 189, 76, 1, 188.958, 0.031, 20880, 0, 1.8e-11,
                    7.9e-12, 0, 0);
  nuc->AddDecay(0, 0, -1, 0.031, 100);

  // Adding 77-IR-189-0
  nuc = new Nucleus("IR", 189, 77, 0, 188.959, 0, 1.14048e+06, 0, 2.4e-10,
                    5.5e-10, 0, 0);
  ...
  // Adding 78-PT-189-0
  nuc = new Nucleus("PT", 189, 78, 0, 188.961, 0, 39132, 0, 1.2e-10, 7.3e-11, 0,
                    0);
  ...
  // Adding 77-IR-190-0
  nuc = new Nucleus("IR", 190, 77, 0, 189.961, 0, 1.01779e+06, 0, 1.2e-09,
                    2.5e-09, 0, 0);
  nuc->AddDecay(0, -1, 0, 2.00001, 100);

  // Adding 77-IR-190-1
  nuc = new Nucleus("IR", 190, 77, 1, 189.961, 0.026, 4320, 0, 1.2e-10, 1.4e-10,
                    0, 0);
  nuc->AddDecay(0, 0, -1, 0.026, 100);

  // Adding 77-IR-190-2
  nuc = new Nucleus("IR", 190, 77, 2, 189.961, 0.175, 11700, 0, 8e-12, 1.1e-11,
                    0, 0);
  nuc->AddDecay(0, -1, -2, 2.17501, 94.4);
  nuc->AddDecay(0, 0, -2, 0.175, 5.6);

  // Adding 78-PT-190-0
  nuc = new Nucleus("PT", 190, 78, 0, 189.96, 0, 2.04984e+19, 0.01, 8.2e-09,
                    2.3e-07, 1, 0);
  ...
  // Adding 76-OS-191-0
  nuc = new Nucleus("OS", 191, 76, 0, 190.961, 0, 1.33056e+06, 0, 5.7e-10,
                    1.8e-09, 0, 0);
  nuc->AddDecay(0, 1, 0, 0.313801, 100);

  // Adding 76-OS-191-1
  nuc = new Nucleus("OS", 191, 76, 1, 190.961, 0.074, 47160, 0, 9.6e-11,
                    1.5e-10, 0, 0);
  ...
  // Adding 78-PT-191-0
  nuc = new Nucleus("PT", 191, 78, 0, 190.962, 0, 250560, 0, 3.4e-10, 1.9e-10,
                    0, 0);
  ...
  // Adding 77-IR-192-0
  nuc = new Nucleus("IR", 192, 77, 0, 191.963, 0, 6.379e+06, 0, 1.4e-09,
                    6.2e-09, 0, 0);
  nuc->AddDecay(0, 1, 0, 1.45971, 95.24);
  nuc->AddDecay(0, -1, 0, 1.04621, 4.76);

  // Adding 77-IR-192-1
  nuc = new Nucleus("IR", 192, 77, 1, 191.963, 0.057, 87, 0, 3.1e-10, 3.6e-08,
                    0, 0);
  ...
  // Adding 77-IR-192-2
  nuc =
      new Nucleus("IR", 192, 77, 2, 191.963, 0.155, 7.60018e+09, 0, 0, 0, 0, 0);
  ...
  // Adding 76-OS-193-0
  nuc = new Nucleus("OS", 193, 76, 0, 192.964, 0, 109800, 0, 8.1e-10, 6.8e-10,
                    0, 0);
  ...
  // Adding 77-IR-193-1
  nuc = new Nucleus("IR", 193, 77, 1, 192.963, 0.08, 909792, 0, 2.7e-10,
                    1.2e-09, 0, 0);
  nuc->AddDecay(0, 0, -1, 0.08, 100);

  // Adding 78-PT-193-0
  nuc = new Nucleus("PT", 193, 78, 0, 192.963, 0, 1.5768e+09, 0, 3.1e-11,
                    2.7e-11, 0, 0);
  nuc->AddDecay(0, -1, 0, 0.0567017, 100);

  // Adding 78-PT-193-1
  nuc = new Nucleus("PT", 193, 78, 1, 192.963, 0.15, 374112, 0, 4.5e-10,
                    2.1e-10, 0, 0);
  nuc->AddDecay(0, 0, -1, 0.15, 100);

  // Adding 79-AU-193-0
  nuc = new Nucleus("AU", 193, 79, 0, 192.964, 0, 63540, 0, 1.4e-10, 1.6e-10, 0,
                    0);
  ...
  // Adding 80-HG-193-0
  nuc = new Nucleus("HG", 193, 80, 0, 192.967, 0, 13680, 0, 8.3e-11, 1.1e-09, 0,
                    0);
  nuc->AddDecay(0, -1, 0, 2.34037, 100);

  // Adding 80-HG-193-1
  nuc = new Nucleus("HG", 193, 80, 1, 192.967, 0.141, 42480, 0, 4e-10, 3.1e-09,
                    0, 0);
  ...
  // Adding 76-OS-194-0
  nuc = new Nucleus("OS", 194, 76, 0, 193.965, 0, 1.89216e+08, 0, 2.4e-09,
                    7.9e-08, 0, 0);
  nuc->AddDecay(0, 1, 0, 0.0965958, 100);

  // Adding 77-IR-194-0
  nuc = new Nucleus("IR", 194, 77, 0, 193.965, 0, 68940, 0, 1.3e-09, 7.5e-10, 0,
                    0);
  nuc->AddDecay(0, 1, 0, 2.2469, 100);

  // Adding 77-IR-194-1
  nuc = new Nucleus("IR", 194, 77, 1, 193.965, 0.19, 1.47744e+07, 0, 2.1e-09,
                    1.2e-08, 0, 0);
  ...
  // Adding 79-AU-194-0
  nuc = new Nucleus("AU", 194, 79, 0, 193.965, 0, 136872, 0, 4.2e-10, 3.9e-10,
                    0, 0);
  nuc->AddDecay(0, -1, 0, 2.49212, 100);

  // Adding 80-HG-194-0
  nuc = new Nucleus("HG", 194, 80, 0, 193.965, 0, 1.63987e+10, 0, 5.1e-08,
                    4e-08, 0, 0);
  nuc->AddDecay(0, -1, 0, 0.0399895, 100);

  // Adding 81-TL-194-0
  nuc = new Nucleus("TL", 194, 81, 0, 193.971, 0, 1980, 0, 8.1e-12, 8.9e-12, 1,
                    0);
  ...
  // Adding 81-TL-194-1
  nuc =
      new Nucleus("TL", 194, 81, 1, 193.971, 0, 1968, 0, 4e-11, 3.7e-11, 0, 0);
  ...
  // Adding 77-IR-195-1
  nuc = new Nucleus("IR", 195, 77, 1, 194.966, 0.1, 13680, 0, 2.1e-10, 2.4e-10,
                    0, 0);
  ...
  // Adding 78-PT-195-1
  nuc = new Nucleus("PT", 195, 78, 1, 194.965, 0.259, 347328, 0, 6.3e-10,
                    3.1e-10, 0, 0);
  nuc->AddDecay(0, 0, -1, 0.259, 100);

  // Adding 79-AU-195-0
  nuc = new Nucleus("AU", 195, 79, 0, 194.965, 0, 1.60782e+07, 0, 2.6e-10,
                    1.6e-09, 0, 0);
  ...
  // Adding 80-HG-195-0
  nuc = new Nucleus("HG", 195, 80, 0, 194.967, 0, 35640, 0, 9.7e-11, 1.4e-09, 0,
                    0);
  nuc->AddDecay(0, -1, 0, 1.50998, 100);

  // Adding 80-HG-195-1
  nuc = new Nucleus("HG", 195, 80, 1, 194.967, 0.176, 149760, 0, 5.6e-10,
                    8.2e-09, 0, 0);
  ...
  // Adding 82-PB-195-1
  nuc = new Nucleus("PB", 195, 82, 1, 194.975, 0.201, 900, 0, 2.9e-11, 3e-11, 0,
                    0);
  ...
  // Adding 79-AU-196-0
  nuc = new Nucleus("AU", 196, 79, 0, 195.967, 0, 534211, 0, 4.4e-10, 3.7e-10,
                    0, 0);
  ...
  // Adding 78-PT-197-0
  nuc = new Nucleus("PT", 197, 78, 0, 196.967, 0, 65880, 0, 4.1e-10, 1.6e-10, 0,
                    0);
  nuc->AddDecay(0, 1, 0, 0.718901, 100);

  // Adding 78-PT-197-1
  nuc = new Nucleus("PT", 197, 78, 1, 196.968, 0.4, 5724.6, 0, 8.4e-11, 4.4e-11,
                    0, 0);
  ...
  // Adding 80-HG-197-0
  nuc = new Nucleus("HG", 197, 80, 0, 196.967, 0, 230904, 0, 2.3e-10, 4.4e-09,
                    0, 0);
  nuc->AddDecay(0, -1, 0, 0.599787, 100);

  // Adding 80-HG-197-1
  nuc = new Nucleus("HG", 197, 80, 1, 196.968, 0.299, 85680, 0, 4.7e-10,
                    5.8e-09, 0, 0);
  nuc->AddDecay(0, 0, -1, 0.299, 93);
  nuc->AddDecay(0, -1, -1, 0.898787, 7);

  // Adding 81-TL-197-0
  nuc = new Nucleus("TL", 197, 81, 0, 196.97, 0, 10224, 0, 2.3e-11, 2.7e-11, 0,
                    0);
  ...
  // Adding 79-AU-198-0
  nuc = new Nucleus("AU", 198, 79, 0, 197.968, 0, 232718, 0, 1e-09, 1.1e-09, 0,
                    0);
  nuc->AddDecay(0, 1, 0, 1.3724, 100);

  // Adding 79-AU-198-1
  nuc = new Nucleus("AU", 198, 79, 1, 197.969, 0.812, 198720, 0, 1.3e-09, 2e-09,
                    0, 0);
  ...
  // Adding 81-TL-198-0
  nuc = new Nucleus("TL", 198, 81, 0, 197.97, 0, 19080, 0, 7.3e-11, 1.2e-10, 0,
                    0);
  nuc->AddDecay(0, -1, 0, 3.45995, 100);

  // Adding 81-TL-198-1
  nuc = new Nucleus("TL", 198, 81, 1, 197.971, 0.544, 6732, 0, 5.5e-11, 7.3e-11,
                    0, 0);
  ...
  // Adding 82-PB-198-0
  nuc =
      new Nucleus("PB", 198, 82, 0, 197.972, 0, 8640, 0, 1e-10, 8.7e-11, 0, 0);
  ...
  // Adding 78-PT-199-0
  nuc = new Nucleus("PT", 199, 78, 0, 198.971, 0, 1848, 0, 3.9e-11, 2.2e-11, 0,
                    0);
  ...
  // Adding 79-AU-199-0
  nuc = new Nucleus("AU", 199, 79, 0, 198.969, 0, 271210, 0, 4.4e-10, 7.6e-10,
                    0, 0);
  ...
  // Adding 80-HG-199-1
  nuc = new Nucleus("HG", 199, 80, 1, 198.969, 0.533, 2556, 0, 3.1e-11, 1.8e-10,
                    0, 0);
  nuc->AddDecay(0, 0, -1, 0.533, 100);

  // Adding 81-TL-199-0
  nuc = new Nucleus("TL", 199, 81, 0, 198.97, 0, 26712, 0, 2.6e-11, 3.7e-11, 0,
                    0);
  ...
  // Adding 82-PB-199-0
  nuc = new Nucleus("PB", 199, 82, 0, 198.973, 0, 5400, 0, 5.4e-11, 4.8e-11, 0,
                    0);
  ...
  // Adding 78-PT-200-0
  nuc =
      new Nucleus("PT", 200, 78, 0, 199.971, 0, 45000, 0, 1.2e-09, 4e-10, 0, 0);
  nuc->AddDecay(0, 1, 0, 0.657331, 100);

  // Adding 79-AU-200-0
  nuc = new Nucleus("AU", 200, 79, 0, 199.971, 0, 2904, 0, 6.8e-11, 5.6e-11, 0,
                    0);
  nuc->AddDecay(0, 1, 0, 2.24408, 100);

  // Adding 79-AU-200-1
  nuc = new Nucleus("AU", 200, 79, 1, 199.972, 0.99, 67320, 0, 1.1e-09, 1e-09,
                    0, 0);
  ...
  // Adding 81-TL-200-0
  nuc =
      new Nucleus("TL", 200, 81, 0, 199.971, 0, 93960, 0, 2e-10, 2.5e-10, 0, 0);
  ...
  // Adding 82-PB-200-0
  nuc =
      new Nucleus("PB", 200, 82, 0, 199.972, 0, 77400, 0, 4e-10, 2.6e-10, 0, 0);
  nuc->AddDecay(0, -1, 0, 0.810452, 100);

  // Adding 83-BI-200-0
  nuc = new Nucleus("BI", 200, 83, 0, 199.978, 0, 2184, 0, 5.1e-11, 5.6e-11, 0,
                    0);
  ...
  // Adding 79-AU-201-0
  nuc = new Nucleus("AU", 201, 79, 0, 200.972, 0, 1560, 0, 2.5e-11, 2.9e-11, 0,
                    0);
  ...
  // Adding 81-TL-201-0
  nuc = new Nucleus("TL", 201, 81, 0, 200.971, 0, 262483, 0, 9.5e-11, 7.6e-11,
                    0, 0);
  ...
  // Adding 82-PB-201-0
  nuc = new Nucleus("PB", 201, 82, 0, 200.973, 0, 33588, 0, 1.6e-10, 1.2e-10, 0,
                    0);
  ...
  // Adding 83-BI-201-0
  nuc = new Nucleus("BI", 201, 83, 0, 200.977, 0, 6480, 0, 1.2e-10, 1.1e-10, 1,
                    0);
  ...
  // Adding 81-TL-202-0
  nuc = new Nucleus("TL", 202, 81, 0, 201.972, 0, 1.05667e+06, 0, 4.5e-10,
                    3.1e-10, 0, 0);
  nuc->AddDecay(0, -1, 0, 1.36441, 100);

  // Adding 82-PB-202-0
  nuc = new Nucleus("PB", 202, 82, 0, 201.972, 0, 1.65564e+12, 0, 8.8e-09,
                    1.4e-08, 0, 0);
  nuc->AddDecay(0, -1, 0, 0.0496159, 99);
  nuc->AddDecay(-4, -2, 0, 2.59763, 1);

  // Adding 82-PB-202-1
  nuc = new Nucleus("PB", 202, 82, 1, 201.974, 2.17, 12708, 0, 1.4e-10, 1.3e-10,
                    0, 0);
  ...
  // Adding 83-BI-202-0
  nuc =
      new Nucleus("BI", 202, 83, 0, 201.978, 0, 6192, 0, 8.9e-11, 1e-10, 0, 0);
  ...
  // Adding 80-HG-203-0
  nuc = new Nucleus("HG", 203, 80, 0, 202.973, 0, 4.02728e+06, 0, 1.9e-09,
                    7e-09, 0, 0);
  ...
  // Adding 82-PB-203-0
  nuc = new Nucleus("PB", 203, 82, 0, 202.973, 0, 186743, 0, 2.4e-10, 1.6e-10,
                    0, 0);
  ...
  // Adding 83-BI-203-0
  nuc = new Nucleus("BI", 203, 83, 0, 202.977, 0, 42336, 0, 4.8e-10, 4.5e-10, 0,
                    0);
  ...
  // Adding 84-PO-203-0
  nuc = new Nucleus("PO", 203, 84, 0, 202.981, 0, 2202, 0, 5.2e-11, 6.1e-11, 0,
                    0);
  ...
  // Adding 81-TL-204-0
  nuc = new Nucleus("TL", 204, 81, 0, 203.974, 0, 1.19206e+08, 0, 1.3e-09,
                    6.2e-10, 0, 0);
  ...
  // Adding 82-PB-204-1
  nuc = new Nucleus("PB", 204, 82, 1, 203.975, 2.186, 4032, 0, 5e-11, 4.4e-11,
                    0, 0);
  ...
  // Adding 82-PB-205-0
  nuc = new Nucleus("PB", 205, 82, 0, 204.974, 0, 4.82501e+14, 0, 2.8e-10,
                    4.1e-10, 0, 0);
  ...
  // Adding 83-BI-205-0
  nuc = new Nucleus("BI", 205, 83, 0, 204.977, 0, 1.32278e+06, 0, 9e-10, 1e-09,
                    0, 0);
  nuc->AddDecay(0, -1, 0, 2.70835, 100);

  // Adding 84-PO-205-0
  nuc = new Nucleus("PO", 205, 84, 0, 204.981, 0, 5976, 0, 5.9e-11, 8.9e-11, 0,
                    0);
  ...
  // Adding 83-BI-206-0
  nuc = new Nucleus("BI", 206, 83, 0, 205.978, 0, 539395, 0, 1.9e-09, 2.1e-09,
                    0, 0);
  nuc->AddDecay(0, -1, 0, 3.75745, 100);

  // Adding 84-PO-206-0
  nuc = new Nucleus("PO", 206, 84, 0, 205.98, 0, 760320, 0, 1.3e-07, 3.7e-07, 1,
                    0);
  ...
  // Adding 83-BI-207-0
  nuc = new Nucleus("BI", 207, 83, 0, 206.978, 0, 9.94961e+08, 0, 1.3e-09,
                    5.3e-09, 0, 0);
  nuc->AddDecay(0, -1, 0, 2.39879, 7);
  nuc->AddDecay(0, -1, 1, 0.765793, 93);

  // Adding 84-PO-207-0
  nuc = new Nucleus("PO", 207, 84, 0, 206.982, 0, 20880, 0, 1.4e-10, 1.5e-10, 0,
                    0);
  ...
  // Adding 85-AT-207-0
  nuc = new Nucleus("AT", 207, 85, 0, 206.986, 0, 6480, 0, 2.3e-10, 2.1e-09, 0,
                    0);
  ...
  // Adding 83-BI-208-0
  nuc = new Nucleus("BI", 208, 83, 0, 207.98, 0, 1.16052e+13, 0, 1.4e-09, 4e-09,
                    0, 0);
  ...
  // Adding 84-PO-208-0
  nuc = new Nucleus("PO", 208, 84, 0, 207.981, 0, 9.13913e+07, 0, 7.7e-07,
                    2.4e-06, 0, 0);
  ...
  // Adding 82-PB-209-0
  nuc = new Nucleus("PB", 209, 82, 0, 208.981, 0, 11710.8, 0, 5.7e-11, 3.2e-11,
                    0, 0);
  ...
  // Adding 84-PO-209-0
  nuc = new Nucleus("PO", 209, 84, 0, 208.982, 0, 3.21667e+09, 0, 7.7e-07,
                    2.4e-06, 1, 0);
  ...
  // Adding 82-PB-210-0
  nuc = new Nucleus("PB", 210, 82, 0, 209.984, 0, 7.03253e+08, 0, 6.8e-07,
                    1.1e-06, 0, 0);
  nuc->AddDecay(0, 1, 0, 0.0635004, 100);
  nuc->AddDecay(-4, -2, 0, 3.79229, 1.9e-06);

  // Adding 83-BI-210-0
  nuc = new Nucleus("BI", 210, 83, 0, 209.984, 0, 433123, 0, 1.3e-09, 8.4e-08,
                    1, 0);
  nuc->AddDecay(-4, -2, 0, 5.0369, 0.00013);
  nuc->AddDecay(0, 1, 0, 1.1627, 100);

  // Adding 83-BI-210-1
  nuc = new Nucleus("BI", 210, 83, 1, 209.984, 0.271, 9.58694e+13, 0, 1.5e-08,
                    3.1e-06, 1, 0);
  nuc->AddDecay(-4, -2, -1, 5.3079, 100);

  // Adding 84-PO-210-0
  nuc = new Nucleus("PO", 210, 84, 0, 209.983, 0, 1.19557e+07, 0, 2.4e-07,
                    3e-06, 1, 0);
  ...
  // Adding 82-PB-211-0
  nuc = new Nucleus("PB", 211, 82, 0, 210.989, 0, 2166, 0, 1.8e-10, 5.6e-09, 0,
                    0);
  ...
  // Adding 85-AT-211-0
  nuc = new Nucleus("AT", 211, 85, 0, 210.987, 0, 25970.4, 0, 1.1e-08, 1.1e-07,
                    0, 0);
  ...
  // Adding 82-PB-212-0
  nuc = new Nucleus("PB", 212, 82, 0, 211.992, 0, 38304, 0, 5.9e-09, 3.2e-07, 0,
                    0);
  nuc->AddDecay(0, 1, 0, 0.573702, 100);

  // Adding 83-BI-212-0
  nuc =
      new Nucleus("BI", 212, 83, 0, 211.991, 0, 3633, 0, 2.6e-10, 4e-08, 0, 0);
  ...
  // Adding 83-BI-213-0
  nuc = new Nucleus("BI", 213, 83, 0, 212.994, 0, 2735.4, 0, 2e-10, 4.2e-08, 0,
                    0);
  ...
  // Adding 83-BI-214-0
  nuc = new Nucleus("BI", 214, 83, 0, 213.999, 0, 1194, 0, 1.1e-10, 2.1e-08, 0,
                    0);
  ...
  // Adding 87-FR-222-0
  nuc =
      new Nucleus("FR", 222, 87, 0, 222.018, 0, 852, 0, 7.1e-10, 2.1e-08, 0, 0);
  ...
  // Adding 87-FR-223-0
  nuc =
      new Nucleus("FR", 223, 87, 0, 223.02, 0, 1308, 0, 2.3e-09, 1.3e-09, 0, 0);
  nuc->AddDecay(0, 1, 0, 1.1491, 99.99);
  nuc->AddDecay(-4, -2, 0, 5.43145, 0.006);

  // Adding 88-RA-223-0
  nuc = new Nucleus("RA", 223, 88, 0, 223.018, 0, 987984, 0, 1e-07, 6.9e-06, 1,
                    0);
  ...
  // Adding 88-RA-224-0
  nuc = new Nucleus("RA", 224, 88, 0, 224.02, 0, 316224, 0, 6.5e-08, 2.9e-06, 1,
                    0);
  ...
  // Adding 89-AC-224-0
  nuc =
      new Nucleus("AC", 224, 89, 0, 224.022, 0, 10440, 0, 7e-10, 1.2e-07, 1, 0);
  ...
  // Adding 88-RA-225-0
  nuc = new Nucleus("RA", 225, 88, 0, 225.024, 0, 1.28736e+06, 0, 9.6e-08,
                    5.8e-06, 0, 0);
  nuc->AddDecay(0, 1, 0, 0.356556, 100);

  // Adding 89-AC-225-0
  nuc = new Nucleus("AC", 225, 89, 0, 225.023, 0, 864000, 0, 2.4e-08, 7.9e-06,
                    1, 0);
  ...
  // Adding 88-RA-226-0
  nuc = new Nucleus("RA", 226, 88, 0, 226.025, 0, 5.04576e+10, 0, 2.8e-07,
                    1.6e-05, 1, 0);
  nuc->AddDecay(-4, -2, 0, 4.8706, 100);
  nuc->AddDecay(-14, -6, 0, 28.1987, 3e-11);

  // Adding 89-AC-226-0
  nuc = new Nucleus("AC", 226, 89, 0, 226.026, 0, 105840, 0, 1e-08, 1.2e-06, 0,
                    0);
  ...
  // Adding 90-TH-226-0
  nuc = new Nucleus("TH", 226, 90, 0, 226.025, 0, 1836, 0, 4.5e-10, 7.7e-08, 1,
                    0);
  ...
  // Adding 88-RA-227-0
  nuc = new Nucleus("RA", 227, 88, 0, 227.029, 0, 2532, 0, 8.4e-11, 2.8e-10, 0,
                    0);
  nuc->AddDecay(0, 1, 0, 1.3251, 100);

  // Adding 89-AC-227-0
  nuc = new Nucleus("AC", 227, 89, 0, 227.028, 0, 6.86633e+08, 0, 1.1e-06,
                    0.00063, 0, 0);
  nuc->AddDecay(0, 1, 0, 0.0447979, 98.62);
  nuc->AddDecay(-4, -2, 0, 5.0422, 1.38);

  // Adding 90-TH-227-0
  nuc = new Nucleus("TH", 227, 90, 0, 227.028, 0, 1.61741e+06, 0, 8.9e-09,
                    9.6e-06, 1, 0);
  nuc->AddDecay(-4, -2, 0, 6.1465, 100);

  // Adding 91-PA-227-0
  nuc = new Nucleus("PA", 227, 91, 0, 227.029, 0, 2298, 0, 4.6e-10, 9.7e-08, 1,
                    0);
  ...
  // Adding 88-RA-228-0
  nuc = new Nucleus("RA", 228, 88, 0, 228.031, 0, 1.81332e+08, 0, 6.7e-07,
                    2.6e-06, 0, 0);
  nuc->AddDecay(0, 1, 0, 0.0458984, 100);

  // Adding 89-AC-228-0
  nuc = new Nucleus("AC", 228, 89, 0, 228.031, 0, 22140, 0, 4.3e-10, 2.9e-08, 0,
                    0);
  nuc->AddDecay(0, 1, 0, 2.1266, 100);
  nuc->AddDecay(-4, -2, 0, 4.82768, 5.5e-06);

  // Adding 90-TH-228-0
  nuc = new Nucleus("TH", 228, 90, 0, 228.029, 0, 6.03315e+07, 0, 7e-08,
                    3.9e-05, 1, 0);
  nuc->AddDecay(-4, -2, 0, 5.5201, 100);

  // Adding 91-PA-228-0
  nuc = new Nucleus("PA", 228, 91, 0, 228.031, 0, 79200, 0, 7.8e-10, 6.9e-08, 0,
                    0);
  ...
  // Adding 90-TH-229-0
  nuc = new Nucleus("TH", 229, 90, 0, 229.032, 0, 2.31474e+11, 0, 4.8e-07,
                    9.9e-05, 1, 0);
  ...
  // Adding 90-TH-230-0
  nuc = new Nucleus("TH", 230, 90, 0, 230.033, 0, 2.37718e+12, 0, 2.1e-07,
                    4e-05, 1, 0);
  nuc->AddDecay(-4, -2, 0, 4.77, 100);
  nuc->AddDecay(0, 1000, 0, 207, 5e-11);

  // Adding 91-PA-230-0
  nuc = new Nucleus("PA", 230, 91, 0, 230.035, 0, 1.50336e+06, 0, 9.2e-10,
                    7.1e-07, 0, 0);
  ...
  // Adding 92-U-230-0
  nuc = new Nucleus("U", 230, 92, 0, 230.034, 0, 1.79712e+06, 0, 5.5e-08,
                    1.5e-05, 1, 0);
  ...
  // Adding 90-TH-231-0
  nuc =
      new Nucleus("TH", 231, 90, 0, 231.036, 0, 91872, 0, 3.4e-10, 4e-10, 0, 0);
  nuc->AddDecay(0, 1, 0, 0.389492, 100);
  nuc->AddDecay(-4, -2, 0, 4.21329, 1e-08);

  // Adding 91-PA-231-0
  nuc = new Nucleus("PA", 231, 91, 0, 231.036, 0, 1.03312e+12, 0, 7.1e-07,
                    0.00013, 1, 0);
  ...
  // Adding 92-U-231-0
  nuc =
      new Nucleus("U", 231, 92, 0, 231.036, 0, 362880, 0, 2.8e-10, 4e-10, 0, 0);
  ...
  // Adding 90-TH-232-0
  nuc = new Nucleus("TH", 232, 90, 0, 232.038, 0, 4.43081e+17, 100, 2.3e-07,
                    4.2e-05, 1, 0);
  nuc->AddDecay(-4, -2, 0, 4.0828, 100);
  nuc->AddDecay(0, 1000, 0, 207, 1e-09);

  // Adding 91-PA-232-0
  nuc = new Nucleus("PA", 232, 91, 0, 232.039, 0, 113184, 0, 7.2e-10, 9.6e-09,
                    0, 0);
  nuc->AddDecay(0, 1, 0, 1.33715, 100);
  nuc->AddDecay(0, -1, 0, 0.495457, 0.003);

  // Adding 92-U-232-0
  nuc = new Nucleus("U", 232, 92, 0, 232.037, 0, 2.17283e+09, 0, 2.9e-07,
                    3.5e-05, 1, 0);
  nuc->AddDecay(-4, -2, 0, 5.4136, 100);

  // Adding 93-NP-232-0
  nuc =
      new Nucleus("NP", 232, 93, 0, 232.04, 0, 882, 0, 9.7e-12, 4.7e-11, 0, 0);
  ...
  // Adding 91-PA-233-0
  nuc = new Nucleus("PA", 233, 91, 0, 233.04, 0, 2.32995e+06, 0, 8.8e-10,
                    3.7e-09, 0, 0);
  nuc->AddDecay(0, 1, 0, 0.570496, 100);

  // Adding 92-U-233-0
  nuc = new Nucleus("U", 233, 92, 0, 233.04, 0, 5.02053e+12, 0, 5e-08, 8.7e-06,
                    1, 0);
  ...
  // Adding 93-NP-233-0
  nuc =
      new Nucleus("NP", 233, 93, 0, 233.041, 0, 2172, 0, 2.2e-12, 3e-12, 0, 0);
  ...
  // Adding 90-TH-234-0
  nuc = new Nucleus("TH", 234, 90, 0, 234.044, 0, 2.08224e+06, 0, 3.4e-09,
                    7.3e-09, 0, 0);
  nuc->AddDecay(0, 1, 1, 0.199089, 100);

  // Adding 91-PA-234-0
  nuc = new Nucleus("PA", 234, 91, 0, 234.043, 0, 24120, 0, 5.1e-10, 5.8e-10, 0,
                    0);
  ...
  // Adding 92-U-234-0
  nuc = new Nucleus("U", 234, 92, 0, 234.041, 0, 7.72632e+12, 0.0055, 4.9e-08,
                    8.5e-06, 0, 0);
  nuc->AddDecay(0, 1000, 0, 207, 1.73e-09);
  nuc->AddDecay(-4, -2, 0, 4.8585, 100);

  // Adding 93-NP-234-0
  nuc = new Nucleus("NP", 234, 93, 0, 234.043, 0, 380160, 0, 8.1e-10, 7.3e-10,
                    0, 0);
  nuc->AddDecay(0, -1, 0, 1.80996, 100);

  // Adding 94-PU-234-0
  nuc = new Nucleus("PU", 234, 94, 0, 234.043, 0, 31680, 0, 1.6e-10, 2.2e-08, 0,
                    0);
  ...
  // Adding 92-U-235-0
  nuc = new Nucleus("U", 235, 92, 0, 235.044, 0, 2.2195e+16, 0.72, 4.6e-08,
                    7.7e-06, 1, 0);
  ...
  // Adding 93-NP-235-0
  nuc = new Nucleus("NP", 235, 93, 0, 235.044, 0, 3.4223e+07, 0, 5.3e-11, 4e-10,
                    0, 0);
  nuc->AddDecay(0, -1, 0, 0.123703, 100);
  nuc->AddDecay(-4, -2, 0, 5.19189, 0.0026);

  // Adding 94-PU-235-0
  nuc = new Nucleus("PU", 235, 94, 0, 235.045, 0, 1518, 0, 2.1e-12, 2.6e-12, 0,
                    0);
  ...
  // Adding 92-U-236-0
  nuc = new Nucleus("U", 236, 92, 0, 236.046, 0, 7.38573e+14, 0, 4.6e-08,
                    7.9e-06, 0, 0);
  nuc->AddDecay(0, 1000, 0, 207, 9.6e-08);
  nuc->AddDecay(-4, -2, 0, 4.572, 100);

  // Adding 93-NP-236-0
  nuc = new Nucleus("NP", 236, 93, 0, 236.047, 0, 4.85654e+12, 0, 1.7e-08,
                    3e-06, 0, 0);
  ...
  // Adding 94-PU-236-0
  nuc = new Nucleus("PU", 236, 94, 0, 236.046, 0, 9.01299e+07, 0, 8.6e-08,
                    1.8e-05, 0, 0);
  ...
  // Adding 92-U-237-0
  nuc = new Nucleus("U", 237, 92, 0, 237.049, 0, 583200, 0, 7.7e-10, 1.8e-09, 0,
                    0);
  nuc->AddDecay(0, 1, 0, 0.518501, 100);

  // Adding 93-NP-237-0
  nuc = new Nucleus("NP", 237, 93, 0, 237.048, 0, 6.7487e+13, 0, 1.1e-07,
                    2.1e-05, 1, 0);
  nuc->AddDecay(-4, -2, 0, 4.95919, 100);
  nuc->AddDecay(0, 1000, 0, 207, 2e-12);

  // Adding 94-PU-237-0
  nuc = new Nucleus("PU", 237, 94, 0, 237.048, 0, 3.90528e+06, 0, 1e-10,
                    3.6e-10, 0, 0);
  ...
  // Adding 95-AM-237-0
  nuc =
      new Nucleus("AM", 237, 95, 0, 237.05, 0, 4380, 0, 1.8e-11, 3.7e-11, 1, 0);
  ...
  // Adding 92-U-238-0
  nuc = new Nucleus("U", 238, 92, 0, 238.051, 0, 1.40903e+17, 99.2745, 4.4e-08,
                    7.3e-06, 1, 0);
  nuc->AddDecay(-4, -2, 0, 4.26978, 100);
  nuc->AddDecay(0, 1000, 0, 207, 5.45e-05);

  // Adding 93-NP-238-0
  nuc = new Nucleus("NP", 238, 93, 0, 238.051, 0, 182909, 0, 9.1e-10, 2e-09, 0,
                    0);
  nuc->AddDecay(0, 1, 0, 1.2921, 100);

  // Adding 94-PU-238-0
  nuc = new Nucleus("PU", 238, 94, 0, 238.05, 0, 2.76697e+09, 0, 2.3e-07,
                    4.3e-05, 1, 0);
  nuc->AddDecay(-4, -2, 0, 5.5932, 100);
  nuc->AddDecay(0, 1000, 0, 207, 1.9e-07);

  // Adding 95-AM-238-0
  nuc = new Nucleus("AM", 238, 95, 0, 238.052, 0, 5880, 0, 3.2e-11, 8.5e-11, 0,
                    0);
  ...
  // Adding 96-CM-238-0
  nuc =
      new Nucleus("CM", 238, 96, 0, 238.053, 0, 8640, 0, 8e-11, 4.9e-09, 0, 0);
  ...
  // Adding 92-U-239-0
  nuc =
      new Nucleus("U", 239, 92, 0, 239.054, 0, 1407, 0, 2.8e-11, 3.5e-11, 0, 0);
  nuc->AddDecay(0, 1, 0, 1.2652, 100);

  // Adding 93-NP-239-0
  nuc = new Nucleus("NP", 239, 93, 0, 239.053, 0, 203602, 0, 8e-10, 1.1e-09, 0,
                    0);
  nuc->AddDecay(0, 1, 0, 0.721802, 100);

  // Adding 94-PU-239-0
  nuc = new Nucleus("PU", 239, 94, 0, 239.052, 0, 7.60333e+11, 0, 2.5e-07,
                    4.7e-05, 0, 0);
  ...
  // Adding 95-AM-239-0
  nuc = new Nucleus("AM", 239, 95, 0, 239.053, 0, 42840, 0, 2.4e-10, 2.9e-10, 1,
                    0);
  ...
  // Adding 92-U-240-0
  nuc = new Nucleus("U", 240, 92, 0, 240.057, 0, 50760, 0, 1.1e-09, 8.4e-10, 1,
                    0);
  nuc->AddDecay(-4, -2, 0, 3.57775, 1e-10);
  nuc->AddDecay(0, 1, 1, 0.388336, 100);

  // Adding 93-NP-240-0
  nuc = new Nucleus("NP", 240, 93, 0, 240.056, 0, 3714, 0, 8.2e-11, 1.3e-10, 0,
                    0);
  ...
  // Adding 94-PU-240-0
  nuc = new Nucleus("PU", 240, 94, 0, 240.054, 0, 2.07002e+11, 0, 2.5e-07,
                    4.7e-05, 1, 0);
  nuc->AddDecay(-4, -2, 0, 5.2558, 100);
  nuc->AddDecay(0, 1000, 0, 207, 5.7e-06);

  // Adding 95-AM-240-0
  nuc = new Nucleus("AM", 240, 95, 0, 240.055, 0, 182880, 0, 5.8e-10, 5.9e-10,
                    0, 0);
  nuc->AddDecay(0, -1, 0, 1.37889, 100);
  nuc->AddDecay(-4, -2, 0, 5.69466, 0.00019);

  // Adding 96-CM-240-0
  nuc = new Nucleus("CM", 240, 96, 0, 240.056, 0, 2.3328e+06, 0, 8.3e-09, 3e-06,
                    1, 0);
  ...
  // Adding 94-PU-241-0
  nuc = new Nucleus("PU", 241, 94, 0, 241.057, 0, 4.52542e+08, 0, 4.7e-09,
                    8.5e-07, 0, 0);
  nuc->AddDecay(0, 1, 0, 0.0207977, 99.998);
  nuc->AddDecay(-4, -2, 0, 5.1401, 0.00245);

  // Adding 95-AM-241-0
  nuc = new Nucleus("AM", 241, 95, 0, 241.057, 0, 1.36456e+10, 0, 2e-07,
                    3.9e-05, 0, 0);
  nuc->AddDecay(0, 1000, 0, 207, 3.77e-10);
  nuc->AddDecay(-4, -2, 0, 5.6378, 100);

  // Adding 96-CM-241-0
  nuc = new Nucleus("CM", 241, 96, 0, 241.058, 0, 2.83392e+06, 0, 9.3e-10,
                    3.8e-08, 0, 0);
  ...
  // Adding 94-PU-242-0
  nuc = new Nucleus("PU", 242, 94, 0, 242.059, 0, 1.17724e+13, 0, 2.4e-07,
                    4.5e-05, 1, 0);
  ...
  // Adding 95-AM-242-0
  nuc =
      new Nucleus("AM", 242, 95, 0, 242.06, 0, 57672, 0, 3e-10, 1.6e-08, 0, 0);
  nuc->AddDecay(0, 1, 0, 0.664799, 82.7);
  nuc->AddDecay(0, -1, 0, 0.750999, 17.3);

  // Adding 95-AM-242-1
  nuc = new Nucleus("AM", 242, 95, 1, 242.06, 0.049, 4.44658e+09, 0, 1.9e-07,
                    3.5e-05, 0, 0);
  ...
  // Adding 96-CM-242-0
  nuc = new Nucleus("CM", 242, 96, 0, 242.059, 0, 1.40651e+07, 0, 1.3e-08,
                    4.9e-06, 1, 0);
  ...
  // Adding 94-PU-243-0
  nuc = new Nucleus("PU", 243, 94, 0, 243.062, 0, 17841.6, 0, 8.5e-11, 1.1e-10,
                    0, 0);
  nuc->AddDecay(0, 1, 0, 0.581509, 100);

  // Adding 95-AM-243-0
  nuc = new Nucleus("AM", 243, 95, 0, 243.061, 0, 2.3242e+11, 0, 2e-07, 3.9e-05,
                    1, 0);
  nuc->AddDecay(-4, -2, 0, 5.4381, 100);
  nuc->AddDecay(0, 1000, 0, 207, 3.7e-09);

  // Adding 96-CM-243-0
  nuc = new Nucleus("CM", 243, 96, 0, 243.061, 0, 9.17698e+08, 0, 2e-07,
                    3.9e-05, 1, 0);
  ...
  // Adding 94-PU-244-0
  nuc = new Nucleus("PU", 244, 94, 0, 244.064, 0, 2.54811e+15, 0, 2.4e-07,
                    4.4e-05, 0, 0);
  nuc->AddDecay(0, 1000, 0, 207, 0.12);
  nuc->AddDecay(-4, -2, 0, 4.6655, 99.88);

  // Adding 95-AM-244-0
  nuc = new Nucleus("AM", 244, 95, 0, 244.064, 0, 36360, 0, 4.6e-10, 1.9e-09, 0,
                    0);
  nuc->AddDecay(0, 1, 0, 1.42782, 100);

  // Adding 95-AM-244-1
  nuc = new Nucleus("AM", 244, 95, 1, 244.064, 0.088, 1560, 0, 2.9e-11, 7.9e-11,
                    0, 0);
  nuc->AddDecay(0, 1, -1, 1.51582, 99.96);
  nuc->AddDecay(0, -1, -1, 0.164173, 0.04);

  // Adding 96-CM-244-0
  nuc = new Nucleus("CM", 244, 96, 0, 244.063, 0, 5.70802e+08, 0, 1.6e-07,
                    3.2e-05, 1, 0);
  ...
  // Adding 98-CF-244-0
  nuc =
      new Nucleus("CF", 244, 98, 0, 244.066, 0, 1164, 0, 7e-11, 1.8e-08, 1, 0);
  ...
  // Adding 94-PU-245-0
  nuc = new Nucleus("PU", 245, 94, 0, 245.068, 0, 37800, 0, 7.2e-10, 6.5e-10, 0,
                    0);
  nuc->AddDecay(0, 1, 0, 1.20468, 100);

  // Adding 95-AM-245-0
  nuc = new Nucleus("AM", 245, 95, 0, 245.066, 0, 7380, 0, 6.2e-11, 7.6e-11, 0,
                    0);
  nuc->AddDecay(0, 1, 0, 0.893906, 100);

  // Adding 96-CM-245-0
  nuc = new Nucleus("CM", 245, 96, 0, 245.065, 0, 2.68056e+11, 0, 3e-07,
                    5.5e-05, 0, 0);
  nuc->AddDecay(0, 1000, 0, 207, 6.1e-07);
  nuc->AddDecay(-4, -2, 0, 5.62351, 100);

  // Adding 97-BK-245-0
  nuc = new Nucleus("BK", 245, 97, 0, 245.066, 0, 426816, 0, 5.7e-10, 2e-09, 1,
                    0);
  ...
  // Adding 94-PU-246-0
  nuc = new Nucleus("PU", 246, 94, 0, 246.07, 0, 936576, 0, 3.3e-09, 7.6e-09, 0,
                    0);
  nuc->AddDecay(0, 1, 1, 0.40049, 100);

  // Adding 95-AM-246-0
  nuc =
      new Nucleus("AM", 246, 95, 0, 246.07, 0, 2340, 0, 5.8e-11, 1.1e-10, 0, 0);
  nuc->AddDecay(0, 1, 0, 2.3762, 100);

  // Adding 95-AM-246-1
  nuc =
      new Nucleus("AM", 246, 95, 1, 246.07, 0, 1500, 0, 3.5e-11, 3.8e-11, 0, 0);
  nuc->AddDecay(0, 1, -1, 2.3762, 100);
  nuc->AddDecay(0, 0, -1, 0, 0.01);

  // Adding 96-CM-246-0
  nuc = new Nucleus("CM", 246, 96, 0, 246.067, 0, 1.49165e+11, 0, 2.9e-07,
                    5.5e-05, 1, 0);
  nuc->AddDecay(-4, -2, 0, 5.4748, 99.97);
  nuc->AddDecay(0, 1000, 0, 207, 0.03);

  // Adding 97-BK-246-0
  nuc = new Nucleus("BK", 246, 97, 0, 246.069, 0, 155520, 0, 4.8e-10, 4.6e-10,
                    1, 0);
  nuc->AddDecay(-4, -2, 0, 6.07384, 0.2);
  nuc->AddDecay(0, -1, 0, 1.35004, 99.8);

  // Adding 98-CF-246-0
  nuc = new Nucleus("CF", 246, 98, 0, 246.069, 0, 128520, 0, 3.3e-09, 4.2e-07,
                    1, 0);
  ...
  // Adding 96-CM-247-0
  nuc = new Nucleus("CM", 247, 96, 0, 247.07, 0, 4.91962e+14, 0, 2.7e-07,
                    5.1e-05, 1, 0);
  nuc->AddDecay(-4, -2, 0, 5.35291, 100);

  // Adding 97-BK-247-0
  nuc = new Nucleus("BK", 247, 97, 0, 247.07, 0, 4.35197e+10, 0, 3.5e-07,
                    6.5e-05, 1, 0);
  ...
  // Adding 96-CM-248-0
  nuc = new Nucleus("CM", 248, 96, 0, 248.072, 0, 1.07222e+13, 0, 1.1e-06,
                    0.0002, 0, 0);
  ...
  // Adding 98-CF-248-0
  nuc = new Nucleus("CF", 248, 98, 0, 248.072, 0, 2.88144e+07, 0, 2.8e-08,
                    8.2e-06, 1, 0);
  ...
  // Adding 96-CM-249-0
  nuc = new Nucleus("CM", 249, 96, 0, 249.076, 0, 3849, 0, 3.1e-11, 5.5e-11, 0,
                    0);
  nuc->AddDecay(0, 1, 0, 0.899925, 100);

  // Adding 97-BK-249-0
  nuc = new Nucleus("BK", 249, 97, 0, 249.075, 0, 2.7648e+07, 0, 9.7e-10,
                    1.5e-07, 0, 0);
  ...
  // Adding 98-CF-249-0
  nuc = new Nucleus("CF", 249, 98, 0, 249.075, 0, 1.10691e+10, 0, 3.5e-07,
                    6.6e-05, 0, 0);
  ...
  // Adding 96-CM-250-0
  nuc = new Nucleus("CM", 250, 96, 0, 250.078, 0, 3.05899e+11, 0, 6.3e-06,
                    0.0011, 0, 0);
  ...
  // Adding 97-BK-250-0
  nuc = new Nucleus("BK", 250, 97, 0, 250.078, 0, 11581.2, 0, 1.4e-10, 9.6e-10,
                    0, 0);
  nuc->AddDecay(0, 1, 0, 1.77972, 100);

  // Adding 98-CF-250-0
  nuc = new Nucleus("CF", 250, 98, 0, 250.076, 0, 4.12491e+08, 0, 1.6e-07,
                    3.2e-05, 1, 0);
  nuc->AddDecay(-4, -2, 0, 6.1284, 99.92);
  nuc->AddDecay(0, 1000, 0, 207, 0.08);

  // Adding 99-ES-250-0
  nuc = new Nucleus("ES", 250, 99, 0, 250.079, 0, 30960, 0, 2.1e-11, 5.9e-10, 0,
                    0);
  ...
  // Adding 98-CF-251-0
  nuc = new Nucleus("CF", 251, 98, 0, 251.08, 0, 2.83193e+10, 0, 3.6e-07,
                    6.7e-05, 1, 0);
  nuc->AddDecay(-4, -2, 0, 6.17581, 100);

  // Adding 99-ES-251-0
  nuc =
      new Nucleus("ES", 251, 99, 0, 251.08, 0, 118800, 0, 1.7e-10, 2e-09, 0, 0);
  ...
  // Adding 98-CF-252-0
  nuc = new Nucleus("CF", 252, 98, 0, 252.082, 0, 8.34127e+07, 0, 9e-08,
                    1.8e-05, 1, 0);
  ...
  // Adding 100-FM-252-0
  nuc = new Nucleus("FM", 252, 100, 0, 252.082, 0, 91404, 0, 2.7e-09, 3e-07, 1,
                    0);
  ...
  // Adding 98-CF-253-0
  nuc = new Nucleus("CF", 253, 98, 0, 253.085, 0, 1.53878e+06, 0, 1.4e-09,
                    0.0001, 0, 0);
  nuc->AddDecay(0, 1, 0, 0.285141, 99.69);
  nuc->AddDecay(-4, -2, 0, 6.12442, 0.31);

  // Adding 99-ES-253-0
  nuc = new Nucleus("ES", 253, 99, 0, 253.085, 0, 1.76861e+06, 0, 6.1e-09,
                    2.5e-06, 1, 0);
  nuc->AddDecay(-4, -2, 0, 6.7392, 100);
  nuc->AddDecay(0, 1000, 0, 207, 8.7e-06);

  // Adding 100-FM-253-0
  nuc = new Nucleus("FM", 253, 100, 0, 253.085, 0, 259200, 0, 9.1e-10, 3.7e-07,
                    1, 0);
  ...
  // Adding 98-CF-254-0
  nuc = new Nucleus("CF", 254, 98, 0, 254.087, 0, 5.2272e+06, 0, 4e-07, 3.7e-05,
                    1, 0);
  nuc->AddDecay(-4, -2, 0, 5.9264, 0.31);
  nuc->AddDecay(0, 1000, 0, 207, 99.69);

  // Adding 99-ES-254-0
  nuc = new Nucleus("ES", 254, 99, 0, 254.088, 0, 2.38205e+07, 0, 2.8e-08,
                    8e-06, 0, 0);
  ...
  // Adding 99-ES-254-1
  nuc = new Nucleus("ES", 254, 99, 1, 254.088, 0.078, 141480, 0, 4.2e-09,
                    4.4e-07, 0, 0);
  ...
  // Adding 100-FM-254-0
  nuc = new Nucleus("FM", 254, 100, 0, 254.087, 0, 11664, 0, 4.4e-10, 7.7e-08,
                    1, 0);
  ...
  // Adding 100-FM-255-0
  nuc = new Nucleus("FM", 255, 100, 0, 255.09, 0, 72252, 0, 2.6e-09, 2.6e-07, 1,
                    0);
  ...
  // Adding 100-FM-257-0
  nuc = new Nucleus("FM", 257, 100, 0, 257.095, 0, 8.6832e+06, 0, 1.5e-08,
                    6.6e-06, 1, 0);
  nuc->AddDecay(-4, -2, 0, 6.8639, 99.79);
  nuc->AddDecay(0, 1000, 0, 207, 0.21);

  // Adding 101-MD-257-0
  nuc = new Nucleus("MD", 257, 101, 0, 257.096, 0, 19080, 0, 1.2e-10, 2.3e-08,
                    0, 0);
  ...
  // Adding 101-MD-258-0
  nuc = new Nucleus("MD", 258, 101, 0, 258.098, 0, 3600, 0, 1.3e-08, 5.5e-06, 0,
                    -8);
