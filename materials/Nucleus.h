...
#ifdef VECGEOM_NVCC
class Nucleus;
extern VECGEOM_CUDA_HEADER_DEVICE vecgeom::map<int, Nucleus*> *fNucleiDev; // Nuclei list indexed by 10,000*z + 10*n + iso
...
extern VECGEOM_CUDA_HEADER_DEVICE vecgeom::map<int, vector<Nucleus* >> *fNatIsoListDev; // List of stable isotopes for a given z
