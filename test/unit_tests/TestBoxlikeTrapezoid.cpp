...
bool TestTrapezoid()
{
  ...
  Trapezoid_t trap3("Trapezoid #3", 22.699999999999999, 0, 0, 24.707000000000001, 0.14999999999999999,
                    0.14999999999999999, 0, 24.707000000000001, 0.14999999999999999, 0.14999999999999999, 0);

  // Check cubic volume

  std::cout << "TestTrapezoid: trap2.Capacity()=" << trap2.Capacity() << ", trap1.Capacity()=" << trap1.Capacity()
            << std::endl;
  ...
  Dist = trap3.DistanceToIn(Vec_t(0.15000000000000185, -22.048743592955137, 2.4268539333219472),
                            Vec_t(-0.76165597579890043, 0.64364445891356026, -0.074515708658524193));
  ...
  Dist = b4.DistanceToIn(Vec_t(-3.0087437277453119577, -4.9999999999999928946, 4.8935648380409944025),
                         Vec_t(0.76315134679548990437, 0.53698876104646497964, -0.35950395323836459305));
  assert(ApproxEqual(Dist, 0.0));
