...
macroShorts=(
    "VECGEOM_FORCE_INLINE[[:space:]]*VECGEOM_CUDA_HEADER_BOTH @GIGB \1VECGEOM_FORCE_INLINE\1VECGEOM_CUDA_HEADER_BOTH\1"
    "VECGEOM_CUDA_HEADER_BOTH[[:space:]]*VECGEOM_FORCE_INLINE @GIGB \1VECGEOM_FORCE_INLINE\1VECGEOM_CUDA_HEADER_BOTH\1"
    "VECGEOM_CUDA_HEADER_BOTH @GB \1VECGEOM_CUDA_HEADER_BOTH\1"
    "VECGEOM_FORCE_INLINE[[:space:]]*VECGEOM_CUDA_HEADER_DEVICE @GIGD \1VECGEOM_FORCE_INLINE\1VECGEOM_CUDA_HEADER_DEVICE\1"
    "VECGEOM_CUDA_HEADER_DEVICE[[:space:]]*VECGEOM_FORCE_INLINE @GIGD \1VECGEOM_FORCE_INLINE\1VECGEOM_CUDA_HEADER_DEVICE\1"
    "VECGEOM_CUDA_HEADER_DEVICE @GD \1VECGEOM_CUDA_HEADER_DEVICE\1"
    "VECGEOM_FORCE_INLINE[[:space:]]*VECGEOM_CUDA_HEADER_HOST @GIGH \1VECGEOM_FORCE_INLINE VECGEOM_CUDA_HEADER_HOST\1"
    "VECGEOM_CUDA_HEADER_HOST[[:space:]]*VECGEOM_FORCE_INLINE @GIGH \1VECGEOM_FORCE_INLINE VECGEOM_CUDA_HEADER_HOST\1"
