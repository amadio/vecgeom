...
#define VECTOR3D_TEMPLATE_INPLACE_BINARY_OP(OPERATOR)                                                  \
  ...
  VECGEOM_CUDA_HEADER_BOTH VECGEOM_INLINE VecType &operator OPERATOR(const Vector3D<OtherType> &other) \
  {                                                                                                    \
...
#define VECTOR3D_BINARY_OP(OPERATOR, INPLACE)                                                              \
  ...
  VECGEOM_INLINE VECGEOM_CUDA_HEADER_BOTH Vector3D<Type> operator OPERATOR(const Vector3D<Type> &lhs,      \
  ...
  VECGEOM_INLINE VECGEOM_CUDA_HEADER_BOTH Vector3D<Type> operator OPERATOR(Vector3D<Type> const &lhs,      \
  ...
  template <typename Type, typename ScalarType>                                                            \
  VECGEOM_INLINE VECGEOM_CUDA_HEADER_BOTH Vector3D<Type> operator OPERATOR(const ScalarType lhs,           \
